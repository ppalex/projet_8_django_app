...
class ChromeFunctionalTestCases(StaticLiveServerTestCase):
    ...
    def setUp(self):       
        ...
        p1 = Product.product_objects.create_product(barcode=1,
        ...
        p2 = Product.product_objects.create_product(barcode=2,
    ...
    def test_user_access_product_detail(self):
        ...
        url = self.live_server_url + ("%s?" % reverse('product', kwargs={'barcode': 2}))
